...
#Version history
v1.1.0: modified code to phase all samples and classify them by a priori species definitions and/or hybrid status.
-- By default, pie graphs showing combinations of alleles now shown.
